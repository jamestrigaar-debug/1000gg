...
(function () {
  ...
  const COUNTRY_ORIGINS = {
    "England": { flag: "🏴󠁧󠁢󠁥󠁮󠁧󠁿", development: 1.0, bias: "balanced", story: "Homegrown under the English rain" },
    "Brazil": { flag: "🇧🇷", development: 1.08, bias: "flair", story: "Samba flair, raw street football" },
    "Argentina": { flag: "🇦🇷", development: 1.05, bias: "clutch", story: "Warrior mentality from Buenos Aires" },
    "France": { flag: "🇫🇷", development: 1.06, bias: "athletic", story: "Elite athletic academy product" },
    "Spain": { flag: "🇪🇸", development: 1.06, bias: "technical", story: "La Masia-style technical grounding" },
    "Germany": { flag: "🇩🇪", development: 1.05, bias: "workrate", story: "Relentless efficiency and pressing" },
    "Portugal": { flag: "🇵🇹", development: 1.04, bias: "flair", story: "Trickery and seaside ambition" },
    "Netherlands": { flag: "🇳🇱", development: 1.05, bias: "technical", story: "Total Football upbringing" },
    "Italy": { flag: "🇮🇹", development: 1.04, bias: "tactical", story: "Tactical schooling from the boot" },
    "Nigeria": { flag: "🇳🇬", development: 1.07, bias: "athletic", story: "Power and pace from West Africa" },
    "Ivory Coast": { flag: "🇨🇮", development: 1.06, bias: "athletic", story: "Strength and street football" },
    "Norway": { flag: "🇳🇴", development: 1.08, bias: "physical", story: "Viking physique and discipline" },
    "Sweden": { flag: "🇸🇪", development: 1.05, bias: "physical", story: "Tall, aerial Scandinavian threat" },
    "Belgium": { flag: "🇧🇪", development: 1.05, bias: "technical", story: "Diamond generation technique" },
    "Scotland": { flag: "🏴󠁧󠁢󠁳󠁣󠁴󠁿", development: 1.02, bias: "workrate", story: "Grit from the Glasgow streets" },
  };
    ...
    el.innerHTML = `
      <div class="profile-grid">
        <div class="profile-card">
          ...
          <div class="pc-meta">Agent rating ${Math.round(agent.influence * 100)}% · Contract bonus ${agent.contractBonus}</div>
        </div>
        <div class="profile-card">
        ...
        <div class="profile-card">
          ...
          <div class="pc-meta">Hidden rating ${state.mentalityRating} · Determination ${state.determination}</div>
        </div>
        <div class="profile-card">
        ...
        <div class="profile-card">
          ...
          <div class="pc-meta">${origin.story} · Dev ${(origin.development * 100).toFixed(0)}%</div>
        </div>
        <div class="profile-card">
          <div class="pc-label">Peak Rating</div>
          <div class="pc-val">${state.baseRating}</div>
          <div class="pc-meta">Potential ${state.potentialRating} · Synergy ${(state.synergyMultiplier * 100).toFixed(0)}%</div>
        </div>
        <div class="profile-card">
          <div class="pc-label">Longevity</div>
          <div class="pc-val">${state.longevity}</div>
          <div class="pc-meta">Retires ~${state.retirementAge}</div>
        </div>
        <div class="profile-card">
          <div class="pc-label">Injury Risk</div>
          <div class="pc-val">${state.injuryRating}</div>
