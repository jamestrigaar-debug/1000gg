...
for (const f of ["rng", "names", "data_intl", "players", "ratings", "international", "tactics", "clubs", "network", "scouting", "managers", "match", "narrative", "youth", "competitions", "agents", "transfers", "ai", "world", "draft", "decisions", "endings"]) {
