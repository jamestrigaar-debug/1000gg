...
for (const f of ["rng", "names", "players", "ratings", "international", "tactics", "clubs", "network", "managers", "match", "narrative", "competitions", "transfers", "world", "draft", "decisions", "endings"]) {
