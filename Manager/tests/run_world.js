...
for (const f of ["rng", "names", "players", "ratings", "international", "tactics", "clubs", "network", "managers", "match", "narrative", "youth", "competitions", "transfers", "world", "draft", "decisions", "endings"]) {
